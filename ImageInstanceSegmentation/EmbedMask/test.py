...
# pip install numpy pillow pandas tqdm opencv-python scipy openpyxl

os.environ["CUDA_VISIBLE_DEVICES"] = '0'

from net import EmbedMask
...
net = EmbedMask() # confidence_threshold=0.2
net_name = 'EmbedMask'
...
for name in tqdm(file_names, desc=f"{net_name}"):
    ...
    outputs, _, _, _, inference_time = net.predict(image_path) 
    ...
    for i in range(nums_object):
        ...
        if i in gt_index:
            ...
            iou_v = iou_matrix[i][pred_mask_index]
